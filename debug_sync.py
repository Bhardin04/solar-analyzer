...
from solar_analyzer.data.models import SolarReading as SolarReadingModel, PanelReading as PanelReadingModel
from solar_analyzer.data.schemas import SolarReadingCreate, PanelReadingCreate
